...
class PullWarehouseShipment extends Command
{
    use DispatchesJobs;
     ...
     */
    protected string $signature = 'bc:create-warehouse-cards';

    /**
     * The console command description.
     */
    protected string $description = 'Pull warehouse shipment from Business Central and create Trello cards';
